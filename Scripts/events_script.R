...
# Event_0_ids <- latest event players cohort id (from amplitude) and players
# Event_1_ids <- previous event players cohort id (from amplitude) and players 

sale_identifier = "Event 11 - Dynamite(II)"
...
event_0_date <- "2017-06-16"
event_1_date <- "2017-05-19"
...
event_0_end <- as.Date(event_0_date)+14
